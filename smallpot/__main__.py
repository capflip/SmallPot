"""SmallPot.
Simple TCP honeypot based off of DevDungeon NanoPot tutorial.
Usage:
  smallpot <config_filepath>
Options:
...
log_filepath = config.get('default', 'logfile', raw=True, fallback="/var/log/smallpot.log")
